...
@section('content')
    ...
    <div id="player_builder" class="h-full relative md:pt-24">
                ...
                <div class="w-full lg:w-1/3 mx-auto lg:ml-0 z-20">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            <x-input v-model="feed_url" label="Paste your feed URL" />
                        </div>
                    </div>

                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            <x-input v-model="episode" label="Episode number or title (leave blank for latest)" />
                        </div>
                    </div>
