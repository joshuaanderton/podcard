<template>
    <div class="h-screen flex align-items-center">
        <div
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="text-xs text-gray-700 inline-block bg-white rounded px-4 py-2 text-gray-500 border border-gray-200">
                Made by
                <a class="text-gray-600 font-bold flex align-items-center" target="_blank" href="https://twitter.com/joshuaanderton">
