...
@section('content')
  ...
  <div v-cloak id="player" data-episode="@js($data)" class="player-wrapper">
    <div class="player">

      <div class="player-controls">

        <div class="player-cover" v-bind:style='{ backgroundImage: `url(${cover})`, backgroundSize: `cover` }'>
        ...
        <div class="player-options">
          <header>
            ...
            <h2 class="player-title" v-if="title">@{{ title }}</h2>
          </header>
          <div v-on:click="seek" class="player-progress" title="Time played : Total time">
            <div :style="{ maxWidth: `${this.percentComplete}%` }" v-if="currentSeconds > 0" class="player-seeker"></div>
          </div>
          <div class="player-buttons">
            <button type="button" class="player-speed">
            ...
            <button type="button" class="player-mute" v-on:click="mute" title="Toggle mute">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
